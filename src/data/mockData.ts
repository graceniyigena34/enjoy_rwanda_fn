export const restaurants = [
  ...
  },
  {
    ...
    menu: [
      { id: 13, name: "Mezze Platter", price: 14000, description: "Assorted fresh dips and bread" },
      { id: 14, name: "Grilled Chicken", price: 11000, description: "Herb-marinated grilled chicken" },
    ],
  },
];
