        ...
        <div className="relative z-10 flex flex-col justify-center px-16 text-white">
          <div className="mb-8">
            ...
            <p className="text-xl text-gray-200 leading-relaxed">
              Join our platform and showcase your business to thousands of visitors exploring the beauty of Rwanda.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-12 bg-gray-50">
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden text-center mb-8">
            <h2 className="text-2xl font-black text-[#1a1a2e]">Welcome to Enjoy Rwanda</h2>
          </div>

          <div className="mb-8">
            <h2 className="text-3xl font-black text-[#1a1a2e] mb-2">Create Account</h2>
            <p className="text-gray-600">Join as a vendor and start your journey</p>
          </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link to="/login" className="text-[#1a1a2e] font-bold hover:underline">
                Sign in
              </Link>
            </p>
          </div>
